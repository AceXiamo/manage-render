<template>
  ...
  >
    <div
      class="bg-white dark:bg-[#141414] min-h-[100px] h-max flex flex-col rounded-md py-[20px] gap-[20px] absolute inset-0"
      :style="{
        width: fullScreen
          ? '100vw'
    ...
    >
      <div class="flex items-center px-[20px]">
        <span class="text-[#333] dark:text-white font-bold text-[15px] select-none">{{
          $props.title
        }}</span>
